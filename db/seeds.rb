...
30.times do 
Apperance.create(guest_id: Guest.all.sample.id, episode_id: Episode.all.sample.id, rating: rand(5))
end 

30.times do 
  Apperance.create(guest_id: Guest.first.id, episode_id: Episode.all.sample.id, rating: rand(5))
  end 
